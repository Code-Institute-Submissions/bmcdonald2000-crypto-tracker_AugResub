...
def view_portfolio(request):
    # user inputs are collected to return portfolio data based on the user input
    if request.method == 'POST':
        ...
        if coin:
            PortfolioTracker.objects.create( user=request.user, crypto=coin, symbol=symbol, tokens=token)
